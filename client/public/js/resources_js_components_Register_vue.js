            ...
            switch (_context.prev = _context.next) {
              case 0:
                if (_this.registerForm.password === _this.registerForm.confirmPassword) {
                  _this.registerForm.name = _this.registerForm.name.toLowerCase().trim();
                  _this.registerForm.email = _this.registerForm.email.toLowerCase().trim();

                  _this.axios.post(_api__WEBPACK_IMPORTED_MODULE_1__.url + "register", _this.registerForm, _api__WEBPACK_IMPORTED_MODULE_1__.config).then(function (response) {
                    ...
                    if (DataResponse.status == 204) {
                      ...
                      sweetalert2__WEBPACK_IMPORTED_MODULE_2___default().fire('Usuario Registrado Correctamente!', '', 'success');
                    }
                  })["catch"](function () {
                    sweetalert2__WEBPACK_IMPORTED_MODULE_2___default().fire('Ha ocurrido un error!', '', 'info');
                  });
                } else {
                  sweetalert2__WEBPACK_IMPORTED_MODULE_2___default().fire('Estas contraseñas no coinciden!', '', 'info');
                }
        ...
        [
          ...
          _c("div", { staticClass: "input-group mb-3" }, [
            _c("input", {
              ...
              domProps: { value: _vm.registerForm.confirmPassword },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
              ...
              _c(
                ...
                [
                  _c(
                    "router-link",
                    {
                      staticClass: "text-center text-decoration-none",
                      attrs: { to: "/login" }
                    },
                    [_vm._v("Ingresar")]
                  )

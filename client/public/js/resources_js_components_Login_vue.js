...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    Login: function Login() {
      this.axios.post(_api__WEBPACK_IMPORTED_MODULE_0__.url + "login", this.loginForm).then(function (response) {
        ...
        if (DataResponse.status == 200) {
          ...
          sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire('Estas credenciales no son validas!', '', 'info');
        }
      })["catch"](function () {
        sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire('Ha ocurrido un error!', '', 'info');
      });
    }
  }
});
